...
void glintFinder::setup(int bigEyeWidth,int bigEyeHeight, float _magRatio){
	...
	eyeImage.allocate((int) (w * magRatio), (int) (h * magRatio));
	bFound = false;
...
//--------------------------------------------------------------------
bool glintFinder::update(ofxCvGrayscaleAdvanced & blackEyeImg, int threshold, int minBlobSize, int maxBlobSize){
