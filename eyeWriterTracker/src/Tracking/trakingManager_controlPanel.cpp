...
void trackingManager::updateGui(){
	...
	tracker.eFinder.nErosions		= panel.getValueI("N_EROSIONS_EYEPOS");
	tracker.eFinder.nDilations		= panel.getValueI("N_DILATIONS_EYEPOS");
	...
	tracker.pFinder.nErosions		= panel.getValueI("N_EROSIONS_PUPIL");
	tracker.pFinder.nDilations		= panel.getValueI("N_DILATIONS_PUPIL");
	...
	tracker.pFinder.blur			= panel.getValueI("BLUR_PUPIL");
...
//	tracker.pFinder.bGauss = panel.getValueB("GAUSS_PUPIL");
	...
	scanX = panel.getValueI("SCAN_X_PUPIL");
	scanY = panel.getValueI("SCAN_Y_PUPIL");


	// Glint Position

//	tracker.threshold_bd			= panel.getValueF("THRESHOLD_BD");
